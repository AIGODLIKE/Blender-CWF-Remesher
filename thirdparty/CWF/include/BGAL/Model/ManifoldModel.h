...
namespace BGAL {
	...
	public:
		...
		{
		public:
			int _id_left_vertex; // 左顶点id
			int _id_right_vertex; // 右顶点id
			int _id_opposite_vertex; // 对边顶点id
			int _id_left_edge; // 左邻边id
			int _id_right_edge; // 右邻边id
			int _id_reverse_edge; // 反向边id
			int _id_face; // 所属的面id
			_MMEdge();
