...
public:
  ...
  void set_max_iteration(const int &max_iteration) { _max_iteration = max_iteration; }

  void set_epsilon(const double &epsilon) { _epsilon = epsilon; }

  void set_num_random_sample(const int &num_random_sample) { _num_random_sample = num_random_sample; }
