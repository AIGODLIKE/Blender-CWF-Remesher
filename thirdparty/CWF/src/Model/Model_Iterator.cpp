...
namespace BGAL {
_Face_Iterator::_Face_Iterator(const _Model *in_model, const int &in_cursor) : _cursor(in_cursor) { _model = in_model; }
...
const _Model::_MFace &_Face_Iterator::operator*() { return _model->_faces[_cursor]; }
...
_Vertex_Iterator::_Vertex_Iterator(const _Model *in_model, const int &in_cursor) : _model(in_model), _cursor(in_cursor) {}
...
const _Point3 &_Vertex_Iterator::operator*() { return _model->_vertices[_cursor]; }
...
_FV_Iterator::_FV_Iterator(const _Model *in_model, const int &in_fid, const int &in_cursor) : _model(in_model), _fid(in_fid), _cursor(in_cursor) {}
...
const _Point3 &_FV_Iterator::operator*() { return _model->_vertices[_model->face_(_fid)[_cursor]]; }
...
_VF_Iterator::_VF_Iterator(const _ManifoldModel *in_model, const int &in_vid, const int &in_cursor) : _model(in_model), _vid(in_vid), _cursor(in_cursor) {
...
_Edge_Iterator::_Edge_Iterator(const _ManifoldModel *in_model, const int &in_cursor) : _model(in_model), _cursor(in_cursor) {}
...
const _ManifoldModel::_MMEdge &_Edge_Iterator::operator*() { return _model->_edges[_cursor]; }
...
_FE_Iterator::_FE_Iterator(const _ManifoldModel *in_model, const int &in_fid, const int &in_cursor) : _model(in_model), _fid(in_fid), _cursor(in_cursor) {
  if (_cursor != 0) {
...
const _ManifoldModel::_MMEdge &_FE_Iterator::operator*() { return _model->_edges[_eid]; }
...
_FF_Iterator::_FF_Iterator(const _ManifoldModel *in_model, const int &in_fid, const int &in_cursor) : _model(in_model), _fid(in_fid), _cursor(in_cursor) {
  if (_cursor != 0) {
    throw std::runtime_error("index error! cursor=" + std::to_string(_cursor));
  }
...
const _Model::_MFace &_FF_Iterator::operator*() { return _model->_faces[_model->edge_(_eid)._id_face]; }
...
_VV_Iterator::_VV_Iterator(const _ManifoldModel *in_model, const int &in_vid, const int &in_cursor) : _model(in_model), _vid(in_vid), _cursor(in_cursor) {
  if (_cursor != 0) {
    throw std::runtime_error("index error! cursor=" + std::to_string(_cursor));
  }
  _eid = _model->_neight_edge_of_vertices[_vid];
...
_VE_Iterator::_VE_Iterator(const _ManifoldModel *in_model, const int &in_vid, const int &in_cursor) : _model(in_model), _vid(in_vid), _cursor(in_cursor) {
  if (_cursor != 0) {
    throw std::runtime_error("index error! cursor=" + std::to_string(_cursor));
  }
  _eid = _model->_neight_edge_of_vertices[_vid];
...
const _ManifoldModel::_MMEdge &_VE_Iterator::operator*() { return _model->_edges[_eid]; }
