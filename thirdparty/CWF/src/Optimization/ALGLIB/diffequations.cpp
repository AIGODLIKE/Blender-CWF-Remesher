...
alglib_impl::odesolverstate *_odesolverstate_owner::c_ptr() const { return const_cast<alglib_impl::odesolverstate *>(p_struct); }
...
alglib_impl::odesolverreport *_odesolverreport_owner::c_ptr() { return p_struct; }

alglib_impl::odesolverreport *_odesolverreport_owner::c_ptr() const { return const_cast<alglib_impl::odesolverreport *>(p_struct); }
...
void odesolverrkck(const real_1d_array &y, const ae_int_t n, const real_1d_array &x, const ae_int_t m, const double eps, const double h, odesolverstate &state, const xparams _xparams) {
  ...
  alglib_impl::odesolverrkck(const_cast<alglib_impl::ae_vector *>(y.c_ptr()), n, const_cast<alglib_impl::ae_vector *>(x.c_ptr()), m, eps, h, const_cast<alglib_impl::odesolverstate *>(state.c_ptr()),
                             &_alglib_env_state);
...
static void odesolver_odesolverinit(ae_int_t solvertype,
                                    ...
                                    /* Real    */ ae_vector *x, ae_int_t m, double eps, double h, odesolverstate *state, ae_state *_state);
...
static void odesolver_odesolverinit(ae_int_t solvertype,
  ...
  for (i = 1; i <= m - 1; i++) {
    if ((ae_fp_greater(x->ptr.p_double[1], x->ptr.p_double[0]) && ae_fp_less_eq(x->ptr.p_double[i], x->ptr.p_double[i - 1])) ||
        (ae_fp_less(x->ptr.p_double[1], x->ptr.p_double[0]) && ae_fp_greater_eq(x->ptr.p_double[i], x->ptr.p_double[i - 1]))) {
      state->repterminationtype = -2;
      return;
    }
  }
